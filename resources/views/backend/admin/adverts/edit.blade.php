...
@section('title', "Edit \"{$advert->title}\"")
...
<section class="section">
    <div class="section-header">
        <h1>Edit "{{ $advert->title }}"</h1>
    </div>

    <div class="section-body">
        <h2 class="section-title">Edit "{{ $advert->title }}"</h2>
        <p class="section-lead">This page is for edit an advert.</p>
        <form id="create-advert-form" class="row" action="{{ route('admin.adverts.update', $advert) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title', $advert->title) }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $type }}" @if(old('type', $advert->type)==$type) selected @endif>
                                            {{ ucfirst($type) }}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                            ...
                            <div class="col-12">
                                ...
                                <label class="custom-switch pl-0 mb-3">
                                    <input type="checkbox" name="is_featured" value="1"
                                        class="custom-switch-input" @if(old('is_featured', $advert->is_featured)) checked @endif>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea style="min-height: 100px" name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="8"
                                        cols="50" placeholder="Short description">{{ old('description', $advert->description) }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback text-small">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="city" id="city" class="form-control @error('city') is-invalid @enderror">
                                        ...
                                        <option value="{{ $city->id }}" @if(old('city', $advert->city_id)==$city->id) selected
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="location" class="form-label">Property location<sup
                                            class="text-danger text-bold">*</sup></label>
                                    <input type="text" id="location" name="location" value="{{ old('location', $advert->location) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="latitude" name="latitude" value="{{ old('latitude', $advert->latitude) }}"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="longitude" name="longitude" value="{{ old('longitude', $advert->longitude) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="number_of_bedrooms" name="number_of_bedrooms"
                                        value="{{ old('number_of_bedrooms', $advert->number_of_bedrooms) }}" placeholder="Number of bedrooms"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="number_of_bathrooms" name="number_of_bathrooms"
                                        value="{{ old('number_of_bathrooms', $advert->number_of_bathrooms) }}" placeholder="Number of bathrooms"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="square" name="square" value="{{ old('square', $advert->square) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="price" name="price" value="{{ old('price', $advert->price) }}"
                                        placeholder="Price"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="period" id="period" class="form-control @error('period') is-invalid @enderror">
                                        ...
                                        <option value="{{ $period }}" @if(old('period', $advert->period)==$period)
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="categories[]" id="categories" style="width: 100%" data-allow-clear="true" class="form-control select2 @error('categories') is-invalid @enderror" multiple="multiple">
                                        ...
                                        <option value="{{ $category->id }}" @if(collect(old('categories', $advert->categories->pluck('id')))->contains($category->id)) selected @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('categories')
                                    <span class="invalid-feedback text-small">
                                    ...
                                    @foreach ($features as $feature)
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" name="features[]" type="checkbox"
                                                id="feature{{ $feature->id }}" value="{{ $feature->id }}" @if(collect(old('features', $advert->features))->contains($feature->id)) checked @endif>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="visit_fees" name="visit_fees" value="{{ old('visit_fees', $advert->visit_fees) }}"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="commission" name="commission" value="{{ old('commission', $advert->commission) }}"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                                                ...
                                                <option value="{{ $singleStatus }}" @if(old('status', $advert->status)==$singleStatus)
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="moderation_status" id="moderation_status"
                                                ...
                                                <option value="{{ $status }}" @if(old('moderation_status', $advert->moderation_status)==$status)
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="account" id="account" class="form-control @error('account') is-invalid @enderror">
                                                ...
                                                <option value="{{ $account->id }}" @if(old('account', $advert->user_id)==$account->id)
